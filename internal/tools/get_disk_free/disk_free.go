...
// GetDiskFreeArgs defines the parameters for the get_disk_free tool.
type GetDiskFreeArgs struct {
...
func GetDiskFree(rawArgs json.RawMessage) (string, error) {
	var args GetDiskFreeArgs
